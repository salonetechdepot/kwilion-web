      ...
      >
        ...
        <div style={{ padding: "30px" }}>
          ...
          <div style={{ textAlign: "center", marginTop: "30px" }}>
            ...
            <a
              href={`mailto:${email}?subject=Re: Your Inquiry to Kwilion Solutions&body=Hi ${name},%0D%0A%0D%0AThank you for reaching out to Kwilion Solutions...`}
              style={{
                display: "inline-block",
                background: "#1e3a8a",
                color: "white",
        ...
        >
          <p>
            This is an automated notification from your Kwilion website contact
            form.
            <br />
